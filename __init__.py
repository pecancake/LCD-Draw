...
try:  
    ...
    draw_text(s, 5, 25, 4, "This is a test string ~")
    draw_text(s, 5, 40, 5, "This is a test string ~")
    draw_text(s, 5, 60, 6, "This is a test string ~")
    draw_text(s, 5, 100, 7, "This is a test string ~")
    draw_text(s, 5, 150, 8, "This is a test string ~")
    s.update()
    time.sleep(3)
